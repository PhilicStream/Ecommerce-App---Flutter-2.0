                  ...
                  child: Card(
                    ...
                    child: SizedBox(
                      ...
                      child: ListView.builder(
                        ...
                        itemCount: UserProvider.address != null ? l.length + 1 : 1,
                              ...
                              ? Padding(
                                  ...
                                  child: ListTile(
                                    trailing: Radio(
                                      ...
                                      onChanged: (v) {
                                        if (widget.pincode == l[index]['pincode']) {
                                          setState(() {
                                          ...
                                          Navigator.push(
                                              context,
                                              MaterialPageRoute(
                                                  builder: (BuildContext context) => CheckOut(widget.type, '${l[index]['name']}',
                                                      '${l[index]['address']}', delivery, widget.sub, widget.saving, widget.total, widget.snapshot)));
                                        } else {
                                          Fluttertoast.showToast(msg: "Please select a valid delivery address");
                                        }
                                      },
                                    ),
                                    title: Text(
